...
impl IntCodeComputer2 {
    pub fn new(codes: &Vec<i64>) -> IntCodeComputer2 {
    ...
    fn write(&mut self, command: i64, v1: i64, result: &mut i64) {
        *result = self.get_value((command % 1000) / 100, v1);
        self.offset += 2;
    }
